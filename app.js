...
game.party.forEach((pkname) => {
  console.log(pkname.name)
})
...
pokemon.forEach((starterpk)=>{
  if(starterpk.starter === true){
    console.log(starterpk)
  }
})
...
game.gyms.forEach((gyms) => {
    ...
    if(gyms.difficulty < 6){
     ...
     console.log(gyms.completed = true);
